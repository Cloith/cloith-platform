...
def get_item(item_name, session_key):
    """fetch your secrets inside your vault and also validates it"""
    cmd = ["bw", "get", "item", item_name, "--session", session_key]
    result = subprocess.run(cmd, capture_output=True, text=True)
    
    if "Not found." in result.stderr:
        raise ItemNotFoundError(f"Item '{item_name}' was not found in your vault.")
    ...
    if not valid:
        raise InvalidItemError(f"The metadata for '{item_name}' is malformed or invalid.")
